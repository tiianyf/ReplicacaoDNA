...
"""
    Cria os 3 arquivos, passando como parâmetro o tamanho (quantidade de
    letras) da string
"""
...
"""
    criando string complementar, pra depois tentar achar ela dentro da string
    inteira A string complementar é o inverso das ligações da String, por
    exemplo, o inverso da string TTGATCA é TGATCAA. Ou seja: seja a string
    (TTGATCA): Inverta ela (ACTAGTT); E substitua com as ligações de
    nucleotídeos (A com T, G com C e vice-versa).
"""
...
"""
    Verifica dentro da string completa se a complementar (criada na função
    anterior) já existe
"""
...
def main():
    ...
    # range(len(string)-1): lista.append(string[i:i+1]) achando as string
    # complementares de tamanho (7 a 9)
